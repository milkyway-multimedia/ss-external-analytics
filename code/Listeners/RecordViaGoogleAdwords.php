...
class RecordViaGoogleAdwords extends HttpListener
{
    ...
    {
        $this->url = singleton('env')->get('GoogleAdwords|ExternalAnalytics.adwords_conversion_url',
            'https://www.googleadservices.com/pagead/conversion/$id?script=0');
    }
